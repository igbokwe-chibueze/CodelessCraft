...
const IdealForEveryone = () => {
  return (
    <div className="w-full h-auto pb-[60px]">
        <div className="w-full flex flex-col justify-center items-center pt-8 lg:pt-[72px] lg:pb-[80px]">
            <div className="lg:w-[564px] px-4 lg:px-[84px] lg:pt-[49px]">
            ...
            <div className="lg:mt-[48px] px-4 lg:px-[120px] py-[36px]">
                <div className="grid md:grid-cols-3">
                    {sectionsData.map((section, index) => (
                        <div key={index}
                            ...
                            className={`relative py-2 lg:py-[36px] px-4 lg:px-[38px] space-y-2 lg:space-y-4 border-l 
